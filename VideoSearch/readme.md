...
swagger-to-sdk:
  ...
  - repo: bing-search-sdk-for-net
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['microsoft_bing_videosearch']
```
...
python:
  ...
  output-folder: $(python-sdks-folder)/bing/microsoft-bing-videosearch/microsoft/bing/videosearch
```
``` yaml $(python) && $(python-mode) == 'create'
python:
  basic-setup-py: true
  output-folder: $(python-sdks-folder)/bing/microsoft-bing-videosearch
```
...
java:
  azure-arm: true
  namespace: com.microsoft.bing.videosearch
  license-header: MICROSOFT_MIT_NO_CODEGEN
  payload-flattening-threshold: 1
  output-folder: $(microsoft-libraries-for-java-folder)/bing/data-plane/videosearch
