...
python:
  ...
  output-folder: $(python-sdks-folder)/bing/microsoft-bing-customimagesearch/microsoft/bing/search/customimagesearch
```
``` yaml $(python) && $(python-mode) == 'create'
python:
  basic-setup-py: true
  output-folder: $(python-sdks-folder)/bing/microsoft-bing-customimagesearch
```
...
java:
  azure-arm: true
  namespace: com.microsoft.bing.customimagesearch
  license-header: MICROSOFT_MIT_NO_CODEGEN
  payload-flattening-threshold: 1
  output-folder: $(microsoft-libraries-for-java-folder)/bing/data-plane/customimagesearch
