...
swagger-to-sdk:
  ...
  - repo: bing-search-sdk-for-net
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['microsoft_bing_customsearch']
```
...
java:
  azure-arm: true
  namespace: com.microsoft.bing.customsearch
  license-header: MICROSOFT_MIT_NO_CODEGEN
  payload-flattening-threshold: 1
  output-folder: $(microsoft-libraries-for-java-folder)/bing/data-plane/customsearch
